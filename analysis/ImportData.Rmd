...
NonstudentsFirstAsk_full <- read_csv("../data/NonstudentsFirstAsk_full.csv", col_names = col_names_S1, skip = 3)
...
NonstudentsSecondAsk_full <- read_csv("../data/NonstudentsSecondAsk_full.csv", col_names = col_names_S1, skip = 3)
...
StudentsSecondAsk_full <- read_csv("../data/StudentsSecondAsk_full.csv", col_names = col_names_S1, skip = 3)
```
