...
```{r}
AskData <- AskData %>% gather(key = "AskCharity", value = "Donation", c(s1_don_int_ha, OxfamDonation, BHFDonation, ns1_donint_ha, ns2_don_dom_hb, ns2_don_dom_ha, S1Donation, s1_don_int_hb, ns2_don_int_hb, ns2_don_int_ha), na.rm = TRUE ) 
