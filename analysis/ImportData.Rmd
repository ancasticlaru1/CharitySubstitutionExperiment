...
# Trying an alternate way to import using qualtRics package 
```{r message=FALSE, warning=FALSE}
...
```{r}
AskData <- AskData %>% mutate(CharityTreat = case_when(firstasktreat == "domestic_ha"               ~ "Domestic",
                                                       firstasktreat == "domestic_happyfirst"       ~ "Domestic",
                                                       firstasktreat == "domestic_hb"               ~ "Domestic",
                                                       firstasktreat == "domestic_happyafter"       ~ "Domestic",
                                                       firstasktreat == "international_happyafter"  ~ "International",
                                                       firstasktreat == "international_ha"          ~ "International",
                                                       firstasktreat == "international_hb"          ~ "International",
                                                       firstasktreat == "international_happyfirst"  ~ "International",
                                                       firstasktreat == "noask"                     ~ "No ask"
                                                      ))
AskData$Donation1 <- NA
AskData <- AskData %>% mutate(Donation1 = ifelse(is.na(Donation1), BHFDonation, Donation1))
AskData <- AskData %>% mutate(Donation1 = ifelse(is.na(Donation1), OxfamDonation, Donation1))
AskData <- AskData %>% mutate(Donation1 = ifelse(is.na(Donation1), s1_don_int_ha, Donation1))
AskData <- AskData %>% mutate(Donation1 = ifelse(is.na(Donation1), s1_don_int_hb, Donation1))
AskData <- AskData %>% mutate(Donation1 = ifelse(is.na(Donation1), s1_don_dom_ha, Donation1))
AskData <- AskData %>% mutate(Donation1 = ifelse(is.na(Donation1), s1_don_dom_hb, Donation1))
AskData <- AskData %>% mutate(Donation1 = ifelse(is.na(Donation1), ask_stc_10_mx25, Donation1 ))
AskData <- AskData %>% mutate(Donation1 = ifelse(is.na(Donation1), ask_cruk_10_mx25a, Donation1 ))

AskData <-AskData %>% select(code, Donation1, everything(), -RecruitmentID, -recruitmentid, -ResponseId, -ResponseID) %>% drop_na(Donation1) %>% group_by(code)
