...
vignettebackground, interviewers, answersmatter, medsalarytold, Q35, vignetteagain, Q36, anspctgradjob, anspctwork, ansavgsalary, Q19 - similar... coded as 1 almost always, otherwise missing only where lots else is missing. We can return to check these later if we need to decide on inclusion/exclusion of obs
