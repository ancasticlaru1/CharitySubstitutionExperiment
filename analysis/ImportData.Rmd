...
DR: A number of differences stem from having previously used "legacy export" which downloads things differently. I believe where there is order randomisation, the legacy export captures the presentation order;  it also captures whether a screen (without a requested response) was shown, which can sometimes be helpful. 
...
Q51 "are you a student" for nonstudents... everyone answers no
...
- @removes rows with only missing data -- it seems to remove *columns* like this!
