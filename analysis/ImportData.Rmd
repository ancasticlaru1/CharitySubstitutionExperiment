...
```{r}
AskData <- AskData %>% mutate(CharityTreat = case_when(firstasktreat == "domestic_ha"               ~ "Domestic-Domestic",
                                                       firstasktreat == "domestic_happyfirst"       ~ "Domestic-Domestic",
                                                       firstasktreat == "domestic_hb"               ~ "Domestic-Domestic",
                                                       firstasktreat == "domestic_happyafter"       ~ "Domestic-Domestic",
                                                       firstasktreat == "international_happyafter"  ~ "Internat.-Internat.",
                                                       firstasktreat == "international_ha"          ~ "Internat.-Internat.",
                                                       firstasktreat == "international_hb"          ~ "Internat.-Internat.",
                                                       firstasktreat == "international_happyfirst"  ~ "Internat.-Internat.",
