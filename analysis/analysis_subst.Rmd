...
#fisher(AskDataExeter[AskData$Stage==2& AskData$CharityTreatf=="Enmity", ]$Donation, AskDataExeter[AskDataExeter$Stage==2& AskDataExeter$GroupRelationship=="Neutral",]$Donation)
