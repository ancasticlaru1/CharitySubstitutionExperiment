...
fisher(AskData[which(AskData$Stage==2 & !is.na(AskData$Donation) & !(AskData$CharityTreatf %in% c("No ask-Domestic", "No ask-Internat."))), ]$Donation, AskData[which(AskData$Stage==2 & !is.na(AskData$Donation) & (AskData$CharityTreatf %in% c("No ask-Domestic", "No ask-Internat."))), ]$Donation) 
